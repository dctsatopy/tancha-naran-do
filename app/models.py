...
class EmotionalScore(Base):
    ...
    anger_state_score: Mapped[float] = mapped_column(Float, nullable=False)
    cognitive_pattern_score: Mapped[float] = mapped_column(Float, nullable=False)
    physiological_score: Mapped[float] = mapped_column(Float, nullable=False)
    behavioral_score: Mapped[float] = mapped_column(Float, nullable=False)
    emotion_regulation_score: Mapped[float] = mapped_column(Float, nullable=False)
